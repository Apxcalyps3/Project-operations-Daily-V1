...
const CountdownTimer = () => {
  ...
  return <div aria-label={`Next challenge in ${hours} hours ${minutes} minutes`} style={{ fontFamily: "'Orbitron', monospace", fontSize: '1.25rem', fontWeight: 'bold', letterSpacing: '0.15em', color: '#4ade80', textShadow: '0 0 10px rgba(74, 222, 128, 0.7)' }}>{hours}:{minutes}:{seconds}</div>;
};
